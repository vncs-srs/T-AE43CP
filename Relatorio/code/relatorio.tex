...
\bibitem{b4} \href{https://www.geeksforgeeks.org/shortest-path-unweighted-graph/}{Shortest path in an unweighted graph - GeeksforGeeks}
\bibitem{b5} \href{https://www.geeksforgeeks.org/minimum-steps-to-reach-the-target/}{Minimum Steps to Reach the Target - GeeksforGeeks}
\bibitem{b6} \href{https://www.geeksforgeeks.org/breadth-first-search-or-bfs-for-a-graph/}{Breadth First Search or BFS for a Graph - GeeksforGeeks}
\bibitem{b7} \href{https://en.wikipedia.org/wiki/Breadth-first_search}{Breadth-first search - Wikipedia}
\end{thebibliography}
\vspace{12pt}
\color{red}
texto aqui
